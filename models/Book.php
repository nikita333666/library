...
class Book extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['title', 'author_firstname', 'author_lastname', 'meta_keywords', 'meta_description', 'image_alt'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        ...
        return [
            ...
            'coverFile' => 'Обложка', // Загружаемая обложка
            'pdfFile' => 'PDF файл', // Загружаемый PDF
            'meta_keywords' => 'META Keywords', // META Keywords
            'meta_description' => 'META Description', // META Description
            'image_alt' => 'ALT текст для изображения', // ALT текст
            'is_hidden' => 'Скрыта', // Статус скрытия
        ];
    }
