...
<div class="admin-books">
    ...
    <div class="books-grid">
        <?php foreach ($dataProvider->getModels() as $book): ?>
            ...
            <div class="book-card <?= $book->is_hidden ? 'hidden-book' : '' ?>"> <a href="<?= Url::to(['book/view', 'id' => $book->id]) ?>"  style="text-decoration: none; color: inherit;     border: none;  outline: none;display: block; ">
